## Living status — keep this section current (last updated 2026-09-11)
...
### 2026-09-11 — bucket auto-classification + manual override, Recently Downloaded list, RESCAN/COPY PATH root-path bug fixed, search UI cleanup, roster data cleanup
