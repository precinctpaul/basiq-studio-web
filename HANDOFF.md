...
**Not yet verified:** a real GO LIVE on YouTube, and a real CBS Live retry, now that both fixes are deployed — same standing rule, real human-initiated attempts only.
